...
export function Leaderboard({
  ...
  return (
    ...
    >
      ...
      >
        <div style={{ color: "rgba(255,255,255,0.45)", fontSize: "0.7rem", letterSpacing: "0.1em" }}>排名</div>
        <div style={{ color: "rgba(255,255,255,0.45)", fontSize: "0.7rem", letterSpacing: "0.1em" }}>日期</div>
        <div style={{ color: "rgba(255,255,255,0.45)", fontSize: "0.7rem", letterSpacing: "0.1em", textAlign: "right" }}>剩餘秒</div>
        <div style={{ color: "rgba(255,255,255,0.45)", fontSize: "0.7rem", letterSpacing: "0.1em", textAlign: "right" }}>得分</div>
            ...
            >
              ...
              <div
                style={{
                  ...
                  borderRadius: "6px",
                  padding: "4px 6px",
                  color: entry ? (isHighlight ? accent : "#ffd700") : baseColor,
                  fontWeight: 800,
                  textAlign: "right",
                  fontVariantNumeric: "tabular-nums",
                }}
